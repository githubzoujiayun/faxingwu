...
public class PublicJiShuHuaTi extends FinalActivity implements OnClickListener {
	...
	private boolean CheckValue() {
		if (mCurrentBitMap1 == null) {
			TispToastFactory.getToast(PublicJiShuHuaTi.this, "请上传问题配图").show();
			return false;
	...
	class UpLoadImage extends AsyncTask<String, Integer, Response> {
		protected void onPreExecute() {
			dialog = ProgressDialog.show(PublicJiShuHuaTi.this, "",
		...
		protected Response doInBackground(String... params) {
			...
			return conn.executeAndParse(Constant.URN_PUBLICSKILL,
					getListInqVal());
		...
		protected void onPostExecute(Response res) {
			...
			if (res.isSuccessful()) {
				TispToastFactory.getToast(PublicJiShuHuaTi.this, res.getMsg())
						.show();
				finish();
			}
